  ...
  render: async function(container, config) {
    ...
    if (!document.getElementById('masters-2026-style')) {
      ...
      s.textContent = `
        ...
        .flag-cell { font-size: 14px; line-height: 1; padding-right: 2px !important; width: 20px; }
    ...
    const loadScores = async () => {
      ...
      for (const p of players) {
        ...
        try {
          ...
          // Parse to-par total: prefer completedRoundsDisplayValue, fall back to value - PAR
          ...
          if (crDisp && crDisp !== '') {
            ...
            p.totVal = raw !== null ? (raw > 20 ? Math.round(raw) - PAR : Math.round(raw)) : 0
          }
